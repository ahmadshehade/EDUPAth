...
class StoreSubscriptionPlanRequest extends BaseRequest {
    ...
    public function rules(): array {
        $rules = [
            'name' => ['required', 'array', new AtLeastOneLocale()],
            'name.en' => ['nullable', 'string', 'max:125', 'min:2', Rule::unique('subscription_plans', 'name->en')],
            'name.ar' => ['nullable', 'string', 'max:125', 'min:2', Rule::unique('subscription_plans', 'name->ar')],
            ...
            'interval' => ['required', 'string', 'in:year,month,week,day'],
    ...
    public function messages(): array {
        return [
            'name.required' => __('validation.required', ['attribute' => __('subscription::validation.attributes.name')]),
            ...
            'name.en.unique' => __('validation.unique', ['attribute' => __('subscription::validation.attributes.name_en')]),
            'name.ar.unique' => __('validation.unique', ['attribute' => __('subscription::validation.attributes.name_ar')]),

            'description.required' => __('validation.required', ['attribute' => __('subscription::validation.attributes.description')]),
            ...
            'price.required' => __('validation.required', ['attribute' => __('subscription::validation.attributes.price')]),
            ...
            'interval.required' => __('validation.required', ['attribute' => __('subscription::validation.attributes.interval')]),
